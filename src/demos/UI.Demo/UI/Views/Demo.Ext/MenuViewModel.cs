...
public class MenuViewModel : ViewModelBase
{
	...
	{
		MenuItems = new ObservableCollection<MenuItemViewModel2>
		{
			...
			new()
			{
				MenuHeader = "Buttons & Inputs", Children = new ObservableCollection<MenuItemViewModel2>
				{
			...
			new()
			{
				MenuHeader = "Dialog & Feedbacks", Children = new ObservableCollection<MenuItemViewModel2>()
				{
			...
			new()
			{
				MenuHeader = "Date & Time", Children = new ObservableCollection<MenuItemViewModel2>
				{
			...
			new()
			{
				MenuHeader = "Navigation & Menus", Children = new ObservableCollection<MenuItemViewModel2>
				{
			...
			new()
			{
				...
				Children = new ObservableCollection<MenuItemViewModel2>
				{
	...
	public ObservableCollection<MenuItemViewModel2> MenuItems { get; set; }
}
