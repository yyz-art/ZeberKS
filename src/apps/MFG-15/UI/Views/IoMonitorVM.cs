...
public partial class IoMonitorVM : CommonUiVM<IoMonitorView> 
{
    ...
    private void InitIoTable()
    {
        IoItems = new ObservableList<IoItemModel>
        {
            ...
            new() { Name = "打印机1触发", Direction = "PLC->PC", Address = "22025", Remark = "1=触发, 收到响应后复位", DataType = "short" },
            new() { Name = "打印机2触发", Direction = "PLC->PC", Address = "22026", Remark = "1=触发, 收到响应后复位", DataType = "short" },
            
            new() { Name = "相机1连接状态", Direction = "PLC->PC", Address = "22030", Remark = "1=正常, 2=断开", DataType = "short" },
            new() { Name = "相机2连接状态", Direction = "PLC->PC", Address = "22031", Remark = "1=正常, 2=断开", DataType = "short" },
            ...
            new() { Name = "上位机错误码", Direction = "PC->PLC", Address = "21002", Remark = "1=扫码枪未连接, 2=MES未连接 , 3=IOT未连接, 4=EAP未连接, 5=打印机未连接", DataType = "short" },
            ...
            new() { Name = "PLC配方写入PC地址请求", Direction = "PC->PLC", Address = "21011", Remark = "1=请求, 0=无请求", DataType = "short" },
            ...
            new() { Name = "扫码枪1触发结果", Direction = "PC->PLC", Address = "21020", Remark = "1=OK, 2=NG, 3=配方等待/未响应", DataType = "short" },
            
            new() { Name = "扫码枪2触发结果", Direction = "PC->PLC", Address = "21021", Remark = "1=OK, 2=NG, 3=配方等待/未响应", DataType = "short" },
            
            new() { Name = "打印机1触发结果", Direction = "PC->PLC", Address = "21025", Remark = "1=OK, 2=扫码枪连接错误, 3=MES返回错误", DataType = "short" },
            new() { Name = "打印机2触发结果", Direction = "PC->PLC", Address = "21026", Remark = "1=OK, 2=扫码枪连接错误, 3=MES返回错误", DataType = "short" },
            
            
            new() { Name = "工单号PC下发", Direction = "PC->PLC", Address = "21100", Remark = "", DataType = "string" },
            new() { Name = "工号PC下发", Direction = "PC->PLC", Address = "21140", Remark = "", DataType = "string" }
        };
    }
