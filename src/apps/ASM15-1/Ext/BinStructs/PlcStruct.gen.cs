...
public partial class PlcStruct
{
	...
	[BinaryPoint(Offset = 4025, Source = "4025", Tags = "PC->PLC", ReaderData = "PLC", WriterData = "PLC", CustomData = null)]
	[ValueInfo(Source = "PLC:4025", Category = "PLC/PC->PLC", Unit = "",MinValue = 0, MaxValue = 4096, Description = "PLC不用，视觉用", InitAttachData = null)]
