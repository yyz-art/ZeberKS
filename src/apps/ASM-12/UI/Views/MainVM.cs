...
public partial class MainVM : UiVM<MainView>
{
	...
	private readonly bool[] _nozzlePressureLimitLogged = new bool[10];
	...
	public partial string Nozzle5PressureCheckValue { get; set; } = "未配置";
	public partial string Nozzle6PressureCheckValue { get; set; } = "未配置";
	public partial string Nozzle7PressureCheckValue { get; set; } = "未配置";
	public partial string Nozzle8PressureCheckValue { get; set; } = "未配置";
	public partial string Nozzle9PressureCheckValue { get; set; } = "未配置";
	public partial string Nozzle10PressureCheckValue { get; set; } = "未配置";
	...
	public partial IBrush Nozzle5PressureBackground { get; set; } = NormalPressureBackground;
	public partial IBrush Nozzle6PressureBackground { get; set; } = NormalPressureBackground;
	public partial IBrush Nozzle7PressureBackground { get; set; } = NormalPressureBackground;
	public partial IBrush Nozzle8PressureBackground { get; set; } = NormalPressureBackground;
	public partial IBrush Nozzle9PressureBackground { get; set; } = NormalPressureBackground;
	public partial IBrush Nozzle10PressureBackground { get; set; } = NormalPressureBackground;
	...
	{
		return int.TryParse(nozzleIndex, out var index) && index is >= 1 and <= 10 ? index : 1;
	}
	...
	private string GetNozzlePressureAddress(int index) => index switch
	{
		...
		5 => AppConfig.Nozzle5PressureAddress,
		6 => AppConfig.Nozzle6PressureAddress,
		7 => AppConfig.Nozzle7PressureAddress,
		8 => AppConfig.Nozzle8PressureAddress,
		9 => AppConfig.Nozzle9PressureAddress,
		10 => AppConfig.Nozzle10PressureAddress,
		_ => "",
	};
	...
	private float GetNozzlePressureMax(int index) => index switch
	{
		...
		5 => AppConfig.Nozzle5PressureMax,
		6 => AppConfig.Nozzle6PressureMax,
		7 => AppConfig.Nozzle7PressureMax,
		8 => AppConfig.Nozzle8PressureMax,
		9 => AppConfig.Nozzle9PressureMax,
		10 => AppConfig.Nozzle10PressureMax,
		_ => 0,
	};
	...
	private float GetNozzlePressureMin(int index) => index switch
	{
		...
		5 => AppConfig.Nozzle5PressureMin,
		6 => AppConfig.Nozzle6PressureMin,
		7 => AppConfig.Nozzle7PressureMin,
		8 => AppConfig.Nozzle8PressureMin,
		9 => AppConfig.Nozzle9PressureMin,
		10 => AppConfig.Nozzle10PressureMin,
		_ => 0,
	};
	...
	private void SetNozzlePressureConfig(int index, string address, float max, float min)
	{
		switch (index)
		{
			case 1: AppConfig.Nozzle1PressureAddress = address; AppConfig.Nozzle1PressureMax = max; AppConfig.Nozzle1PressureMin = min; break;
			case 2: AppConfig.Nozzle2PressureAddress = address; AppConfig.Nozzle2PressureMax = max; AppConfig.Nozzle2PressureMin = min; break;
			case 3: AppConfig.Nozzle3PressureAddress = address; AppConfig.Nozzle3PressureMax = max; AppConfig.Nozzle3PressureMin = min; break;
			case 4: AppConfig.Nozzle4PressureAddress = address; AppConfig.Nozzle4PressureMax = max; AppConfig.Nozzle4PressureMin = min; break;
			case 5: AppConfig.Nozzle5PressureAddress = address; AppConfig.Nozzle5PressureMax = max; AppConfig.Nozzle5PressureMin = min; break;
			case 6: AppConfig.Nozzle6PressureAddress = address; AppConfig.Nozzle6PressureMax = max; AppConfig.Nozzle6PressureMin = min; break;
			case 7: AppConfig.Nozzle7PressureAddress = address; AppConfig.Nozzle7PressureMax = max; AppConfig.Nozzle7PressureMin = min; break;
			case 8: AppConfig.Nozzle8PressureAddress = address; AppConfig.Nozzle8PressureMax = max; AppConfig.Nozzle8PressureMin = min; break;
			case 9: AppConfig.Nozzle9PressureAddress = address; AppConfig.Nozzle9PressureMax = max; AppConfig.Nozzle9PressureMin = min; break;
			case 10: AppConfig.Nozzle10PressureAddress = address; AppConfig.Nozzle10PressureMax = max; AppConfig.Nozzle10PressureMin = min; break;
		}
	}
	...
	private void SetNozzlePressureDisplay(int index, string value, IBrush background)
	{
		switch (index)
		{
			case 1: Nozzle1PressureCheckValue = value; Nozzle1PressureBackground = background; break;
			case 2: Nozzle2PressureCheckValue = value; Nozzle2PressureBackground = background; break;
			case 3: Nozzle3PressureCheckValue = value; Nozzle3PressureBackground = background; break;
			case 4: Nozzle4PressureCheckValue = value; Nozzle4PressureBackground = background; break;
			case 5: Nozzle5PressureCheckValue = value; Nozzle5PressureBackground = background; break;
			case 6: Nozzle6PressureCheckValue = value; Nozzle6PressureBackground = background; break;
			case 7: Nozzle7PressureCheckValue = value; Nozzle7PressureBackground = background; break;
			case 8: Nozzle8PressureCheckValue = value; Nozzle8PressureBackground = background; break;
			case 9: Nozzle9PressureCheckValue = value; Nozzle9PressureBackground = background; break;
			case 10: Nozzle10PressureCheckValue = value; Nozzle10PressureBackground = background; break;
		}
	}
