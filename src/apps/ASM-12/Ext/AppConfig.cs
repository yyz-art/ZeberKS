...
public partial class AppConfig : CommonAppConfig
{
    ...
    public partial string ManualVisionSn { get; set; } = "";

    public partial string ManualVisionImagePath { get; set; } = "";
    ...
    public partial string Nozzle8PressureAddress { get; set; } = "";
    public partial float Nozzle8PressureMax { get; set; }
    public partial float Nozzle8PressureMin { get; set; }
    public partial string Nozzle9PressureAddress { get; set; } = "";
    public partial float Nozzle9PressureMax { get; set; }
    public partial float Nozzle9PressureMin { get; set; }
    public partial string Nozzle10PressureAddress { get; set; } = "";
    public partial float Nozzle10PressureMax { get; set; }
    public partial float Nozzle10PressureMin { get; set; }
