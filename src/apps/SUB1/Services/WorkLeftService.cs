				...
				try
				{
					if (CodeScanner is not { IsOpen: true })
					{
						...
						if (openResult.IsError())
						{
							...
							Plc.Write.工位1允许生产 = 2;
							SetFlowError(1, $"扫码枪1打开失败: {openResult.Message}");
							goto SendCodeNG;
						}
					}
					...
					if (writeResult.IsError())
					{
						...
						Plc.Write.工位1允许生产 = 2;
						SetFlowError(1, $"扫码枪1触发失败: {writeResult.Message}");
						goto SendCodeNG;
					}
					...
					if (readResult.IsError())
					{
						...
						Plc.Write.工位1允许生产 = 2;
						SetFlowError(1, $"扫码枪1读取失败: {readResult.Message}");
						goto SendCodeNG;
					}
