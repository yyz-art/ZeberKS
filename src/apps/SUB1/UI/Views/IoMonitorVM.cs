...
public partial class IoMonitorVM : CommonUiVM<IoMonitorView> 
{
    ...
    private void InitIoTable()
    {
        IoItems = new ObservableList<IoItemModel>
        {
            ...
            new() { Name = "相机3连接状态", Direction = "PLC->PC", Address = "22032", Remark = "1=正常, 2=断开", DataType = "short" },
            new() { Name = "相机4连接状态", Direction = "PLC->PC", Address = "22033", Remark = "1=正常, 2=断开", DataType = "short" },
