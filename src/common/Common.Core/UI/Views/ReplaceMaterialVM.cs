...
public partial class ReplaceMaterialVM : CommonUiVM<ReplaceMaterialWindow>
{
	...
	// 	}
	//
	// 	var feederInfo = _currentRecipe?.MaterialConfigs?.ElementAtOrDefault(_feederIndex - 1);
	...
	// 	}
	//
	// 	var savedFeederCode = feederInfo.PositionCode?.Trim() ?? "";
	...
	// private static bool IsMaterialMatched(MaterialUploadConfig feederInfo, string materialCode)
	// {
	// 	return string.Equals(feederInfo.MaterialCodes?.Trim(), materialCode, StringComparison.Ordinal) ||
